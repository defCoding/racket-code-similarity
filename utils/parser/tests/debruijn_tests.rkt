...
(check-equal? (convert-ast-to-debruijn atom-test1) atom-test1)
(check-equal? (convert-ast-to-debruijn atom-test2) atom-test2)
(check-equal? (convert-ast-to-debruijn atom-test3) atom-test3)
(check-equal? (convert-ast-to-debruijn atom-test4) atom-test4)
...
(check-equal? (convert-ast-to-debruijn simple-test1) (Let
                                       (Var 'a) (Int 3)
                                       (Let (Var 'b) (Int 4)
                                            (Apply (Op '+)
                                                   (list
...
(check-equal? (convert-ast-to-debruijn simple-test2) (Lambda (list (Var 'x))
                                              (Apply (Op '+)
                                                     (list
                                                      (Var 'v0)
                                                      (Int 1)))))
(check-equal? (convert-ast-to-debruijn simple-test3) (Lambda (list (Var 'x) (Var 'y))
                                              (Apply (Op '+)
                                                     (list
                                                      (Var 'v1)
                                                      (Var 'v0)))))
(check-equal? (convert-ast-to-debruijn simple-test4) (Def (Var 'square)
                                           (list (Var 'n))
                                           (Apply (Op '*)
                                                  (list
                                                   (Var 'v0)
                                                   (Var 'v0)))))
(check-equal? (convert-ast-to-debruijn simple-test5) (Let
                                       (Var 'x) (Int 1)
                                       (Apply (Var 'add1)
                                              (list (Var 'v0)))))
...
(check-equal? (convert-ast-to-debruijn complex-test1)
              (Let
               (Var 'x) (Int 1)
               (Let
                (Var 'y) (Int 2)
                     ...
                     (Let (Var 'x) (Int 4)
                          (Apply (Op '+)
                                 (list
                                  (Var 'v0)
                                  (Var 'v2))))))))))))
(check-equal? (convert-ast-to-debruijn complex-test2)
              (Lambda
...
(check-equal? (convert-ast-to-debruijn complex-test3)
              (Let
               (Var 'a)
               (Int 3)
               (Let
...
(check-equal? (convert-ast-to-debruijn complex-test4)
              (Def
               (Var 'append)
...
(check-equal? (convert-ast-to-debruijn complex-test5)
...
(check-equal? (convert-ast-to-debruijn ast-program1)
              (Program
               (list
                (Def
                 (Var 'even?)
...
(check-equal? (convert-ast-to-debruijn ast-program2)
              (Program
               (list
                (Def
                 (Var 'div-5?)
...
(check-equal? (convert-ast-to-debruijn ast-program3)
              (Program
               (list
