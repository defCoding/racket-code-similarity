...
(provide convert-ast-to-debruijn)

; convert-ast-to-debruijn : → AST AST
; convert-ast-to-debruijn takes an AST and calls debruijnize with an empty environment.
(define (convert-ast-to-debruijn ast)
  (debruijnize ast '()))
